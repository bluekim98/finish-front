  ...
  <VRow>
        ...
        <div class="d-flex justify-space-between flex-wrap flex-md-nowrap flex-column flex-md-row">
          ...
          <div>
            ...
            <VCardActions class="justify-space-between">
              ...
              <VBtn color="secondary" icon="ri-share-line" />
            </VCardActions>
          </div>
        </div>
      </VCard>
            ...
            <VCardText class="d-flex justify-center">
              <div class="me-auto pe-4">
                <p class="d-flex align-center mb-6">
                  <VIcon color="primary" icon="ri-lock-unlock-line" />
                  <span class="ms-3">Full Access</span>
                </p>

                <p class="d-flex align-center mb-0">
                  <VIcon color="primary" icon="ri-user-line" />
              ...
              <div class="ms-auto ps-4">
                <p class="d-flex align-center mb-6">
                  <VIcon color="primary" icon="ri-star-line" />
                  <span class="ms-3">Access all Features</span>
                </p>

                <p class="d-flex align-center mb-0">
                  <VIcon color="primary" icon="ri-pie-chart-2-line" />
    ...
    <VCol cols="12" lg="4" md="6">
      <VCard title="The Best Answers">
        ...
        <VCardText>become fast, easy and simple. If you want your promotional material to be an eye-catching</VCardText>
    ...
    <VCol cols="12" md="6" lg="4">
      <VCard class="text-center">
        <VCardText class="d-flex flex-column justify-center align-center">
          <VAvatar color="primary" variant="outlined" size="50" class="mb-4">
            <VIcon size="2rem" icon="ri-question-line" />
          </VAvatar>
