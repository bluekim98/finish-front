            ...
            <VCol md="6">
              <VRow class="px-3 gap-6">
                <VCol class="pt-0 px-0">
                  <span class="text-overline">운영 시작일</span>
                  <DatePicker v-model="query.openDateStart" />
                </VCol>
                <VCol class="pt-0 px-0">
                  <span class="text-overline">운영 종료일</span>
        ...
        <VTable width="100%">
          <thead>
            <tr>
              ...
              <th class="text-center no-wrap">수강권명</th>
              <th class="text-center no-wrap">강사명</th>
              <th class="text-center no-wrap">지점</th>
              <th class="text-center no-wrap">카테고리</th>
              <th class="text-center no-wrap">운영기간</th>
              <th class="text-center no-wrap">
                수강권
                <br />
                가격
              </th>
              <th class="text-center no-wrap">운영여부</th>
